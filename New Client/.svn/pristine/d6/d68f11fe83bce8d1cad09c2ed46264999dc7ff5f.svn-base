...
public class ClientView extends JFrame {
	...
	public JRadioButton radioUDP = null;
	public JRadioButton radioTCP = null;
	...
	public ClientView() {
		...
		radioTCP.setBounds(10, 8, 57, 27);
		

		radioUDP = new JRadioButton("UDP");
		radioUDP.setBounds(65, 8, 65, 27);

		ButtonGroup radioGroup = new ButtonGroup();
		radioGroup.add(radioTCP);
		radioGroup.add(radioUDP);

		contentPane.add(radioTCP);
		contentPane.add(radioUDP);
